...
public class ForceRemoveCmd extends DJCommand
{
    public ForceRemoveCmd(Bot bot)
    {
        ...
        this.help = "Retire toutes les entrées d'un utilisateur de la queue";
        this.arguments = "<user>";
    ...
    public void doCommand(CommandEvent event)
    {
        ...
        {
            event.replyError("Vous devez mentionner un utilisateur !");
            return;
        }
        ...
        if(found.isEmpty())
        {
            event.replyError("Impossible de trouver cet utilisateur !");
            return;
        }
